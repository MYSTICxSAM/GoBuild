...
function BmodelArchitect() {
  const stakeholders = [
    { name: 'Interior Designer ', position: 'left-top', side: 'left', icon: '🛋️', color: 'from-orange-400 to-red-500' },
    { name: 'Industrial Architect', position: 'left-middle', side: 'left', icon: '🏭', color: 'from-green-400 to-emerald-500' },
    { name: 'Residential Architect', position: 'left-bottom', side: 'left', icon: '🏠', color: 'from-purple-400 to-violet-500' },
    { name: 'Restaurant Architect', position: 'right-top', side: 'right', icon: '🍛', color: 'from-yellow-400 to-amber-500' },
    { name: 'Store/Shop Architect', position: 'right-middle', side: 'right', icon: '🛍️', color: 'from-blue-400 to-cyan-500'},
    { name: 'Kitchen Architect', position: 'right-bottom', side: 'right', icon: '🍽️', color: 'from-teal-400 to-green-500' }
  ];
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold bg-purple-600 bg-clip-text text-transparent mb-4 sm:mb-6">
            GoBuild Best Architects 
          </h2>
          <p className="text-base sm:text-lg lg:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed px-4">
            We bring architects, builders, and clients together through one seamless digital ecosystem
          </p>
        </div>
              ...
              <div className="relative">
                ...
                <div className="relative w-28 h-28 sm:w-36 sm:h-36 lg:w-44 lg:h-44 m-1 sm:m-2 lg:m-2 bg-white/90 backdrop-blur-lg rounded-full shadow-2xl flex items-center justify-center border border-gray-200/50 transition-all duration-500 group-hover:shadow-blue-500/30 group-hover:scale-105">
                  <div className="text-center">
                    <div className="text-2xl sm:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-teal-600 bg-clip-text text-transparent mb-1 sm:mb-2 lg:mb-2 transition-all duration-500 group-hover:scale-110">A</div>
                    <div className="text-sm sm:text-lg lg:text-xl font-bold bg-gradient-to-r from-blue-800 to-purple-800 bg-clip-text text-transparent transition-all duration-500">Architect</div>
                  </div>
                </div>
...
export default BmodelArchitect;