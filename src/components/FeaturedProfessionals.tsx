    ...
    <section id="professionals" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4">Meet Our Top Professionals</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            These skilled individuals have consistently delivered exceptional work and earned stellar reviews from clients like you.
          </p>
        </div>
        
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          <ProfessionalCard
            name="Parveen Sangral"
            profession="Designer"
            image="/pp2.jpg"
            rating={4.9}
            reviewCount={124}
            ...
            verification={["Top Rated", "Background Check", "5+ Years", "Insured"]}
            delay={100}
          />
