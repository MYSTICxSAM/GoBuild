        ...
        <div className="flex flex-col-reverse md:flex-row md:gap-16 items-center justify-between w-full">
          <div className="w-full md:w-1/2 mb-8 md:mb-0 animate-fade-in">
            <h1 className="text-4xl sm:text-5xl font-extrabold mb-6">
              ...
              <span className={accentColor}>Expert Workers</span>
              <span className="text-black"> for Any Task</span>
            </h1>
            <p className="text-gray-700 text-lg mb-6">
              Book skilled professionals for your home and office needs – from carpentry and plumbing to electrical work, all in one place. Reliable, verified experts at your fingertips!
            </p>
          ...
          <div className="w-full md:w-1/2 flex justify-center items-center animate-fade-in animation-delay-200">
            <img
              src="https://media.istockphoto.com/id/163204230/photo/young-construction-worker-carrying-wood-boards.jpg?s=612x612&w=0&k=20&c=fImTSVkOFQqwiyc2keRYbQQCOFfwSMMkrCCKN7d6ujY="
